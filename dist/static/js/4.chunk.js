(this["webpackJsonprecipe_extension"] = this["webpackJsonprecipe_extension"] || []).push([[4],{

/***/ "./node_modules/@react-firebase/database/dist/index.esm.js":
/*!*****************************************************************!*\
  !*** ./node_modules/@react-firebase/database/dist/index.esm.js ***!
  \*****************************************************************/
/*! exports provided: FirebaseDatabaseNode, FirebaseDatabaseNodes, FirebaseDatabaseProvider, FirebaseDatabaseMutation, FirebaseDatabaseTransaction, getFirebaseQuery, initializeFirebaseApp */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FirebaseDatabaseNode", function() { return FirebaseDatabaseNode; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FirebaseDatabaseNodes", function() { return FirebaseDatabaseNodes; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FirebaseDatabaseProvider", function() { return FirebaseDatabaseProvider; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FirebaseDatabaseMutation", function() { return FirebaseDatabaseMutation; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FirebaseDatabaseTransaction", function() { return FirebaseDatabaseTransaction; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFirebaseQuery", function() { return getFirebaseQuery; });
...
/* harmony import */ var render_and_add_props__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! render-and-add-props */ "./node_modules/render-and-add-props/dist/index.esm.js");
...
var getContext = lodash_memoize__WEBPACK_IMPORTED_MODULE_1___default()(function (createContext$$1) {
  if (createContext$$1 === void 0) {
    createContext$$1 = function (defaultContext) {
      return Object(react__WEBPACK_IMPORTED_MODULE_0__["createContext"])(defaultContext);
    };
  }
...
var FirebaseDatabaseProvider = function (_super) {
  ...
  FirebaseDatabaseProvider.prototype.render = function () {
    ...
    return Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])(FirebaseDatabaseContextProvider, {
      value: this.state
    }, Object(render_and_add_props__WEBPACK_IMPORTED_MODULE_2__["renderAndAddProps"])(children, {}));
  };
...
var FirebaseDatabaseContextConsumerLifeCycle = function (_super) {
  ...
  function FirebaseDatabaseContextConsumerLifeCycle() {
    ...
    _this.onValue = function (props, v) {
      ...
      var unsortedKeys = lodash_keys__WEBPACK_IMPORTED_MODULE_5___default()(value);
      var sortedKeys = orderByChild ? lodash_sortBy__WEBPACK_IMPORTED_MODULE_4___default()(unsortedKeys, function (key) {
        return value[key][orderByChild];
      }) : orderByKey ? lodash_sortBy__WEBPACK_IMPORTED_MODULE_4___default()(unsortedKeys, function (key) {
        return key;
      }) : orderByValue ? lodash_sortBy__WEBPACK_IMPORTED_MODULE_4___default()(unsortedKeys, function (key) {
        return value[key];
      }) : unsortedKeys;
  ...
  FirebaseDatabaseContextConsumerLifeCycle.prototype.render = function () {
    ...
    return Object(render_and_add_props__WEBPACK_IMPORTED_MODULE_2__["renderAndAddProps"])(this.props.children, {
      path: path,
      value: value,
      isLoading: isLoading
    });
...
var FirebaseDatabaseNode = function (_super) {
  ...
  FirebaseDatabaseNode.prototype.render = function () {
    ...
    return Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])(FirebaseDatabaseContextConsumer, null, function (context) {
      return Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])(FirebaseDatabaseContextConsumerLifeCycle, __assign({
...
var addNodeToState = function (state, _a) {
  var id = _a.id,
      value = _a.value,
      isLoading = _a.isLoading;
  var updatedState = Object(immer__WEBPACK_IMPORTED_MODULE_3__["default"])(state, function (newState) {
    lodash_set__WEBPACK_IMPORTED_MODULE_6___default()(newState, "value." + id + ".value", value);
    lodash_set__WEBPACK_IMPORTED_MODULE_6___default()(newState, "value." + id + ".isLoading", isLoading);
    return newState;
  });
  return updatedState;
};
...
var FirebaseDatabaseNodes = function (_super) {
  ...
  FirebaseDatabaseNodes.prototype.render = function () {
    ...
    return Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, this.props.nodes.map(function (node) {
      return Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])(FirebaseDatabaseNode, __assign({
        path: node.path,
        key: node.id
      }, node.query), function (_a) {
        var value = _a.value,
            isLoading = _a.isLoading;
        return Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])(PureNodeReader, {
          value: value,
          isLoading: isLoading,
          id: node.id,
    ...
    }), Object(render_and_add_props__WEBPACK_IMPORTED_MODULE_2__["renderAndAddProps"])(this.props.children, this.state));
  };
...
var FirebaseDatabaseMutationWithContext = function (_super) {
  ...
  FirebaseDatabaseMutationWithContext.prototype.render = function () {
    ...
    return Object(render_and_add_props__WEBPACK_IMPORTED_MODULE_2__["renderAndAddProps"])(children, __assign({
...
var FirebaseDatabaseMutation = function (_super) {
  ...
  FirebaseDatabaseMutation.prototype.render = function () {
    ...
    var FirebaseDatabaseContextConsumer = getContext().FirebaseDatabaseContextConsumer;
    return Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])(FirebaseDatabaseContextConsumer, null, function (context) {
      return Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])(FirebaseDatabaseMutationWithContext, __assign({
        type: type,
        path: path
      }, context, {
        children: children
...
var FirebaseDatabaseTransaction = function (_super) {
  ...
  FirebaseDatabaseTransaction.prototype.render = function () {
    ...
    var FirebaseDatabaseContextConsumer = getContext().FirebaseDatabaseContextConsumer;
    return Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])(FirebaseDatabaseContextConsumer, null, function (context) {
      return Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])(FirebaseDatabaseTransactionWithContext, __assign({
        path: path
      }, context, {
        children: children
      }));
...
/*!*************************************************!*\
  !*** ./node_modules/immer/dist/immer.module.js ***!
  \*************************************************/
/*! exports provided: produce, setAutoFreeze, setUseProxies, applyPatches, Immer, original, isDraft, nothing, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/render-and-add-props/dist/index.esm.js":
/*!*************************************************************!*\
  !*** ./node_modules/render-and-add-props/dist/index.esm.js ***!
  \*************************************************************/
/*! exports provided: default, renderAndAddProps */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "renderAndAddProps", function() { return renderAndAddProps; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
...
var renderAndAddProps = function (renderable, props) {
  ...
  } else if (react__WEBPACK_IMPORTED_MODULE_0__["Children"].count(renderable) > 0) {
    return react__WEBPACK_IMPORTED_MODULE_0__["Children"].map(renderable, function (child) {
      return Object(react__WEBPACK_IMPORTED_MODULE_0__["cloneElement"])(child, props);
    });
  } else if (Object(react__WEBPACK_IMPORTED_MODULE_0__["isValidElement"])(renderable)) {
    return Object(react__WEBPACK_IMPORTED_MODULE_0__["cloneElement"])(renderable, props);
  }

  return null;
};

/* harmony default export */ __webpack_exports__["default"] = (renderAndAddProps);
